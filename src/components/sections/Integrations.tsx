        ...
        <section className="py-24 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {/* Left Card - Integration Hub Visualization */}
                    <motion.div
                    ...
                    >
                        ...
                        >
                            <div className="relative">
                                ...
                                />
                                <div className="w-20 h-20 rounded-full bg-slate-800 shadow-xl border border-white/20 flex items-center justify-center relative z-10">
                        ...
                        <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ zIndex: 5 }}>
                            ...
                            <motion.line x1="50%" y1="50%" x2="75%" y2="15%" stroke="url(#lineGrad)" strokeWidth="1" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 0.6, duration: 0.6 }} />
                            <motion.line x1="50%" y1="50%" x2="85%" y2="30%" stroke="url(#lineGrad)" strokeWidth="1" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 0.7, duration: 0.6 }} />
                            <motion.line x1="50%" y1="50%" x2="90%" y2="50%" stroke="url(#lineGrad)" strokeWidth="1" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 0.8, duration: 0.6 }} />
                            <motion.line x1="50%" y1="50%" x2="82%" y2="72%" stroke="url(#lineGrad)" strokeWidth="1" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 0.9, duration: 0.6 }} />
                            <motion.line x1="50%" y1="50%" x2="70%" y2="88%" stroke="url(#lineGrad)" strokeWidth="1" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 1.0, duration: 0.6 }} />
                            {/* Lines from center to left icons */}
                            <motion.line x1="50%" y1="50%" x2="15%" y2="40%" stroke="url(#lineGrad)" strokeWidth="1" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 0.5, duration: 0.6 }} />
                            <motion.line x1="50%" y1="50%" x2="15%" y2="60%" stroke="url(#lineGrad)" strokeWidth="1" initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ delay: 0.55, duration: 0.6 }} />
                        </svg>
